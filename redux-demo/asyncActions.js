...
// action creators
const fetchUserRequest = () => ({ type: FETCH_USER_REQUSTED });
const fetchUserSuccess = (users) => ({ type: FETCH_USER_SUCCEEDED, payload: users });
const fetchUserFailure = (error) => ({ type: FETCH_USER_FAILED, payload: error });
